      ...
      <div className="flex flex-col items-center md:flex-row">
        <motion.div className="grid items-center w-full mb-8 md:w-auto md:mb-0">
          <div className="text-center md:text-start">
            ...
            <motion.p initial={{ y: 80, opacity: 0 }} transition={{ duration: .2, delay: .2 }} whileInView={{ opacity: 1, y: 0 }} className="mt-4 text-base md:mt-6 md:text-xl lg:text-2xl text-secondary 2xl:text-3xl">
            ...
            <motion.div className="flex md:mb-[2rem] justify-center md:justify-start flex-col md:flex-row gap-4 mt-6 md:mt-10">
              ...
              <span className="hidden my-auto text-white md:inline-block">Or</span>{" "}
              <a href="tel:+351976234342" className="flex items-center justify-center gap-3 mt-2 text-white md:justify-start md:mt-0 click">
        ...
        <motion.div initial={{ y: 90, opacity: 0 }} transition={{ duration: 1, delay: .4 }} whileInView={{ opacity: 1, y: 0 }} className="w-full md:-mb-9 md:w-[70%] relative">
          <Overlay />
